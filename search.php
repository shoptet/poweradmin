    ...
    <table>
        <tr>
            <td>
                ...
                <input type="checkbox" class="input" name="records" value="true"<?php echo $parameters['records'] ? : ''; ?>><?php echo _('Records'); ?> |
                <input type="checkbox" class="input" name="wildcard" value="true"<?php echo $parameters['wildcard'] ? : ''; ?>><?php echo _('Wildcard'); ?>
                <input type="checkbox" class="input" name="reverse" value="true"<?php echo $parameters['reverse'] ? : ''; ?>><?php echo _('Reverse'); ?>
